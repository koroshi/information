...
html ->
  head ->
    ...
    title '信息管理系统'
    script 'data-main':"js/reg.js", src:"lib/require.js"
#    script 'data-main':"lib/built.js", src:"lib/require.js"


  body style:"height:100%; background-color: #428bca;", 'ng-app':'regApp', ->
          ...
          div class:"form-horizontal", 'role':"form", ->
            div class:"form-group ", ->
              div class:"col-xs-12", id:'registArea', ->
                ...
                description:'用户名', id:'txtName', name:'username', placeholder:'用户名', ->

                input type:"password", class:"form-control validator", validator:"password", required:"required",
                description:'密码', id:'txtPassword', name:'password', placeholder:'密码', ->

                input type:"text", class:"form-control validator", validator:"specialChar", required:"required",
                description:'确认密码',id:'txtConfirm', name:'password', placeholder:'确认密码', ->

                input type:"text", class:"form-control validator", validator:"email", required:"required",
                description:'邮箱', id:'txtEmail', name:'password', placeholder:'邮箱', ->

                input type:"text", class:"form-control validator", validator:"phone", required:"required",
                description:'手机号码', id:'txtPhone', name:'password', placeholder:'手机号码', ->

                input type:"text", class:"form-control validator", validator:"specialChar",
                description:'地址', id:'txtAddr', name:'password', placeholder:'地址', ->

            div class:"form-group", ->
              div class:"col-xs-12", ->
                a class:"btn btn-default col-xs-3 ", href:'/login', ->'登录'
                button class:"btn btn-default col-xs-8 col-xs-offset-1 ", id:"loginBtn",type:"button",onclick:'regist()', ->'注册'
            div ->
              if @error?
